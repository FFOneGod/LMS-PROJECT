...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        ...
        <h1 className='welcome-text home-heading-large relative font-bold text-gray-800 max-w-3xl mx-auto'>
        ...
        <p className='md:hidden text-gray-400 max-w-sm mx-a'>We bring together world-class instructors to help you achieve your personal and professional goals.</p>
